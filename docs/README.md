...
![](https://s2.ax1x.com/2019/09/03/nF10fg.png)
...
?> 【注】　邓家钰师兄利用 VBA 语言实现了这一功能，可以参看附录中的 `guangyun/raw-data/deng-approach.xlsm` 文件。
...
![](https://s2.ax1x.com/2019/09/03/nF1hhF.png)
