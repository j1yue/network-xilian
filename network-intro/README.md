...
　　目前，网络分析方法在音韵学，特别是上古音领域的应用较为广泛。但从。因此，我们按照耿振生（2004）总结的研究方法，分节加以叙述。
...
　　游函（List, [2018](https://hal.archives-ouvertes.fr/hal-01706927v2/document): §2.1）利用有向图，分析了谐声系列与三等/非三等的关系。
